...
Install plone.palette with uv.

```shell
uv add plone.palette
```
...
Generated from the [`cookieplone-templates`  template](https://github.com/plone/cookieplone-templates/tree/main/) on 2026-05-29 10:11:52.. A special thanks to all contributors and supporters!
